...
public class Employee {
    ...
    CommandLineOutputService outputService = new CommandLineOutputService();
    ...
    private void meetDepartmentStaff() {
        metDeptStaff = true;
        outputService.simpleOutput(firstName + " " + lastName + " met with dept staff on "
                + getFormattedDate());
    }
    ...
    public void reviewDeptPolicies() {
        ...
        outputService.simpleOutput(firstName + " " + lastName + " reviewed dept policies on "
                + getFormattedDate());
    }
    ...
    public void moveIntoCubicle(String cubeId) {
        ...
        this.movedIn = true;
        outputService.simpleOutput(firstName + " " + lastName + " moved into cubicle "
    ...
    public void setLastName(String lastName) {
        if (validateString(lastName)) {
            outputService.simpleOutput("last name is required");
        }
    ...
    public void setSsn(String ssn) {
        if (ssn == null || ssn.length() < minLength || ssn.length() > maxLength) { // Magic numbers!
            outputService.simpleOutput("ssn is required and must be "
    ...
    public void setCubeId(String cubeId) {
        if (validateString(cubeId)) {
            outputService.simpleOutput("cube id is required");
        }
        this.cubeId = cubeId;
    }
